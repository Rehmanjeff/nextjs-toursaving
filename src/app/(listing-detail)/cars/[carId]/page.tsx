   ...
   const renderSection1 = () => {
      return (
         ...
         <div className="flex flex-col-reverse gap-1 md:flex-row md:gap-0 items-start">
            ...
            <div className="flex items-center">
               <Image className="rounded-md sm:rounded-xl" src="https://images.unsplash.com/photo-1542362567-b07e54358753?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80&w=640&q=75" alt="car main thumbnail" width="400" height="300" />
            </div>
         </div>
