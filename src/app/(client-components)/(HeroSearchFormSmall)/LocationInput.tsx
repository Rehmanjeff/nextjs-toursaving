...
const LocationInput: FC<LocationInputProps> = ({
   ...
   const renderSearchValue = () => {
      return (
         <>
         {locations.map((item) => (
            <span onClick={() => handleSelectLocation(item.name)} key={item.id}className="flex px-4 sm:px-6 items-center space-x-3 py-4 hover:bg-neutral-100 dark:hover:bg-neutral-700 cursor-pointer">
